...
class Review(Timestampable, models.Model):
    ...
    place = models.CharField(
        "Place name", blank=True, max_length=255, default="",
        help_text='Square Image MIN_SIZE=320x320, MAX_SIZE=900x900')
...
class Tag(Timestampable, models.Model):
    ...
    name = models.CharField(
        "Tag name", max_length=255, default="",
        help_text="Prefer use without spaces (Could be with  '_' or '-')")
    description = models.CharField(
        "Short description", blank=True, max_length=255, default="")
...
class Photo(Timestampable, models.Model):
    ...
    project = models.ForeignKey(
        "gallery.Project", models.SET_NULL, blank=True, null=True,
        related_name="photos", help_text='Select one project')
    service = models.ForeignKey(
        "gallery.Service", models.SET_NULL, blank=True, null=True,
        related_name="photos", help_text='Select one Service')
...
class Project(Timestampable, models.Model):
    ...
    brand = models.CharField(
        "Company brand", max_length=100, choices=BRAND_OPTIONS,
        default="MILLWORK", help_text="Select the correct!")
    title = models.CharField("Title of project", max_length=255, default="")
    slug = models.SlugField(
        "Url slug", max_length=255, blank=True,
        default="", help_text='This field is auto-generated')
    ...
    status_project = models.CharField(
        "Status of the project", blank=True, max_length=255, choices=STATUS_PROJECT_OPTIONS,
        default="COMPLETED", help_text='Select one')
    main_picture = models.ImageField(
        "Main picture for project", upload_to='projects', blank=True)
...
class Service(Timestampable, models.Model):
    ...
    slug = models.SlugField(
        "Url slug", max_length=255, blank=True, default="",
    ...
    main_picture =  models.ImageField(
        "Main picture for project", upload_to='services', blank=True)
